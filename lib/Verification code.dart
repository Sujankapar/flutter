import 'package:first_project/DuabaMap.dart';
import 'package:first_project/googlemap.dart';
                ...
                children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      TextButton(onPressed: (){Navigator.of(context).push(MaterialPageRoute(builder: (builder) =>Location1()));
                      },
